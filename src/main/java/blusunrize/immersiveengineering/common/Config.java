...
public class Config {
    ...
    public static HashMap<String, Boolean> config_boolean = new HashMap<String, Boolean>();
    ...
    public static HashMap<String, double[]> config_doubleArray = new HashMap<String, double[]>();
    public static HashMap<String, int[]> config_intArray = new HashMap<String, int[]>();
    public static HashMap<String, String[]> config_stringArray = new HashMap<String, String[]>();
